{
    init: function(elevators, floors) {
        ...
        var listPassangersInElevator = function(elevatorNumber, logparam) {
            ...
            for (var c = counter ; c>0 ; c-- ) {                      
                if(prevLoad!=0 && passingersInElevators[c][elevatorNumber]>0){
            ...
            if (logparam=="ShowLog")
                console.log("Elevator " + elevatorNumber + " getIn/getOff " + (currLoad-prevLoad).toFixed(2) + "  prevLoad:" + prevLoad.toFixed(2) + " currLoad:" + currLoad.toFixed(2));
        ...
        var floorButtonPressedBehavior = function (elevator,  elevatorNumber, FloorBtnPressed, behavior, logparam) {
            ...
            listPassangersInElevator(elevatorNumber, "ShowLog");
        }

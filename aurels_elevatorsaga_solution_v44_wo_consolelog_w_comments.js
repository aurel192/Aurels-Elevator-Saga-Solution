...
// elevate-me.hu min 1564 avg 1600 max 1641
    init: function(elevators, floors) {              
        ...
        for (var e=0 ; e<elevators.length ; e++) {    // EACH ELEVATOR HAS AN ADDITIONAL PROPERTY FOR SHOWING
            ...
            for (var f=0 ; f<floors.length ; f++)     // FOR EXAMPLE: elevators[0].waitingInside[3] == 12 
        ...
        floorButtonPressed = function (elevator, FloorBtnPressed) {             // WHEN A BUTTON IS PRESSED INSIDE AN ELEVATOR
            elevators[elevator.index].waitingInside[FloorBtnPressed] = timer;   // THE TIMERS VALUE IS ASSIGNED TO THE ELEVATORS WAITINGINSIDE[FloorBtnPressed] PROPERTY
        ...
        stoppedAtFloor = function (elevator, Floor) {              // EACH TIME THE ELEVATOR STOPS
            ...
            elevators[elevator.index].waitingInside[Floor] = -1;   // AND RESET THE TIMER INSIDE THE ELEVATOR

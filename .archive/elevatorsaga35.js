{
    init: function(elevators, floors) {
        ...
        passingFloor = function (elevator, passFloorNum, direction, logparam) { 
            
            if (logparam == "ShowLog") 
               console.log("Elevator " + elevator.index + " Passing Floor " + passFloorNum + ". Direction:" + direction + " Queue: " + elevator.destinationQueue);    
        }
                       
        stoppedAtFloor  = function (elevator, Floor, logparam) {
            visitNearestFirst(elevator.index, -1, "ShowLog");               
        ...
        _.each(elevators, function(elevator,index) {
            ...
            elevator.on("passing_floor", function(passFloorNum, direction) {
                passingFloor(elevator, passFloorNum, direction, "nShowLog");   
            });

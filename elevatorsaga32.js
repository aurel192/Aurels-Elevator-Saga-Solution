{
    init: function(elevators, floors) {
        ...
        var visitNearestFirst = function (elevatorNumber, visitFloor, logparam) {        
            //if (elevatorNumber!=3)     return;
        ...
        var nearestFloor = function (elevator, logparam) {                
            var nearest = -1;
            var distance = 99;
        ...
        var floorButtonPressedBehavior = function (elevator, elevatorNumber, FloorBtnPressed, behavior, logparam) {            
            ...
            switch (behavior) {
                ...
                case "rearrangeByClosestFloors":
                    rearrangeByClosestFloors(elevatorNumber, FloorBtnPressed, "ShowLog");
                    updateIndicators(true,"TWOALL");
                    break;
                case "visitNearestFirst":
                    visitNearestFirst(elevatorNumber, FloorBtnPressed, "ShowLog");
                    updateIndicators(true,"TWOALL");
                    break;                    
        ...
        var ButtonPressedOnFloor  = function (floor, UpOrDownBtn, freeSpace, sendImmediately, logparam) {       
            ...
            if (LeastLoadedElevator != -1 && LeastLoadedElevatorsFreeSpace>=freeSpace) {
                ...
                else {  // DQ rendezés kell (ha van szabad hely, akkor kerüljön előrébb a floor a DQ-ban, emeleteket sorrendben kéne megláatni)
        ...
        _.each(elevators, function(elevator,index) {
            ...
            elevator.on("floor_button_pressed", function(floorNum) {
                floorButtonPressedBehavior(elevator, index, floorNum, "visitNearestFirst", "ShowLog");
            });
        ...
        _.each(floors, function(floor) {
            floor.on("down_button_pressed", function() {
                ButtonPressedOnFloor( floor.floorNum(), "down_button_pressed", 2, false, "NShowLog" );
            });             
            floor.on("up_button_pressed", function() {
                ButtonPressedOnFloor( floor.floorNum(), "up_button_pressed", 2, false, "NShowLog" );
            });             
        });     
    },
...
// Elapsed time3624s
// Transported/s 1.49
// Avg waiting time 18.7s
// Max waiting time178.7s
// Moves 44207
